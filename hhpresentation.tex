...
\begin{frame}{Opportunities for Future Research}
\begin{enumerate}
\item Experiment with decreasing the refactory period by changing the membrane capacitance.
\item Isolate neurons by disabling parts of the axon with train potentials.
\item Study isolated neuron responces.
\end{enumerate}
\end{frame}
