...
\begin{frame}{Naive Mechanism}
  \begin{figure}
    ...
    \caption{Equal ratio of current to capacitance}
  \end{figure}
\end{frame}
...
\begin{frame}{Mechanism}
  \begin{figure}
    ...
    \caption{Unequal ratio of current to capacitance}
  \end{figure}
\end{frame}
...
\begin{frame}{Least-squares spectral analysis}
  \begin{figure}
    ...
    \caption{The Lomb-Scargle Periodogram works with variable intervals.}
  \end{figure}
\end{frame}
